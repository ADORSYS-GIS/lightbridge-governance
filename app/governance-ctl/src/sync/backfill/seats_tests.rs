//! Integration tests for the once-per-run seat snapshot inside
//! `run_backfill_at`, against a mock GitHub and real Postgres. Split out of
//! the single `backfill.rs` test module (#178); the day-report integration
